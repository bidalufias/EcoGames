...
export const GAMES: readonly GameDefinition[] = [
  ...
  },
  {
    id: 'switch-off',
    title: 'Switch Off!',
    tagline: 'Switch off what nobody is using in a busy Malaysian home.',
    category: 'arcade',
    icon: 'power',
    image: 'lightbulb',
    art: ['television', 'snowflake', 'plug'],
    accent: 'coral',
    minutes: '1–2 min',
    howTo: [
      'The family moves around the house and leaves things on.',
      'Switch off anything left on in an empty room before the electricity meter fills up.',
      'Leave things on where someone is using them!',
    ],
