...
export const GAMES: readonly GameDefinition[] = [
  ...
  },
  {
    ...
    tagline: 'Merge seeds into trees, trees into forests, and grow all the way to the Amazon.',
    category: 'puzzle',
    icon: 'trees',
    image: 'tree',
    art: ['seedling', 'globe-americas', 'palm-tree'],
    accent: 'leaf',
    minutes: '3–8 min',
    isNew: true,
    howTo: [
      ...
      'Grow a seed into a tree, trees into a rainforest, and all the way to the Amazon.',
    ],
    howToMobile: [
